...
<p><strong>2. ROOF MOUNT.</strong> For specific hardware, consult the <a class="module" href="/docs/cck/building-mounting/learn-about-rooftop-mounts">Learn about Rooftop Mounts</a> module.</p>
...
<p>This module should be considered a companion to <a class="module" href="/docs/cck/building-mounting/pre-install-rooftop-nodes">Prep and Install Rooftop Nodes</a>, <a class="module">Learn about Rooftop Mounts</a>, and <a class="module" href="/docs/cck/builing-mounting/learn-about-rooftop-mounts">Learn Rooftop Basics</a>.</p>
</section>
